...
| Var | Type |
| --- | --- |
| rewardPool | struct Mining2R.PoolInfo |
| rewardToken0 | contract IERC20 |
| rewardToken1 | contract IERC20 |
| uniV3NFTManager | contract PositionManagerV3 |
| rewardUpperTick | int24 |
| rewardLowerTick | int24 |
| accRewardPerShare0 | uint256 |
| accRewardPerShare1 | uint256 |
| lastTouchBlock | uint256 |
| rewardPerBlock0 | uint256 |
| rewardPerBlock1 | uint256 |
| totalVLiquidity | uint256 |
| startBlock | uint256 |
| endBlock | uint256 |
| owners | mapping(uint256 => address) |
| tokenStatus | mapping(uint256 => struct Mining2R.TokenStatus) |
| Q128 | uint256 |
...
```solidity
  ...
  ) external returns (address token0_, address token1_, uint24 fee_, address rewardToken0_, address rewardToken1_, int24 rewardUpperTick_, int24 rewardLowerTick_, uint256 rewardPerBlock0_, uint256 rewardPerBlock1_, uint256 totalVLiquidity_, uint256 startBlock_, uint256 endBlock_)
```
...
```solidity
  function deposit(
    uint256 tokenId
  ) public returns (uint256 vLiquidity)
```
...
#### Declaration
```solidity
  function modifyRewardPerBlock0(
...
| Arg | Type | Description |
| --- | --- | --- |
|`_rewardPerBlock0` | uint256 | New end block.

### modifyRewardPerBlock1
Set new reward per block.
...
#### Declaration
```solidity
  function modifyRewardPerBlock1(
...
| Arg | Type | Description |
| --- | --- | --- |
|`_rewardPerBlock1` | uint256 | New end block.
