...
async function setApprovalForAll(i) {
  ...
  const a = await manager.positions(i)
  console.log(a)
...
setApprovalForAll(process.argv[2]).then(() => process.exit(0)).catch((error) => {console.error(error); process.exit(1);})
