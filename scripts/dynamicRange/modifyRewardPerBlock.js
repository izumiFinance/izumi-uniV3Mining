...
const pk = secret.pk;
const pk2 = secret.pk2;
// example
// HARDHAT_NETWORK='izumiTest' \
//     node modifyRewardPerBlock.js \
...
const web3 = getWeb3();
const miningABI = getContractABI(__dirname + '/../../artifacts/contracts/miningDynamicRangeBoost/MiningDynamicRangeBoostV2.sol/MiningDynamicRangeBoostV2.json');
